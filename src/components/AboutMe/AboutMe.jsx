    ...
    <>
      <div className="flex flex-col gap-10">
        ...
        <p>
          ...
          coding, and without even noticing I made a career switch. I was
          doubling my monthly income, so it felt the right time to go all in on
          web development.
        </p>
        <p>
          In 2021 I moved to Spain and started working as a Frontend Developer
          in advertising, building websites for end clients. The following year,
          I joined Grupo Juinsa, where I grew as a Frontend Developer, working
