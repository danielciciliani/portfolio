export const ExperienceData = [
    {
        ...
        details: [
        <>
            In the process of building a Startup, to provide AI powered solutions for small companies and entrepreneurs.
        </>
        ],
    },
    {
        ...
        details: [
        <>
            Developed a real-time dashboard using React to monitor
            deployments in Staging and Production environments, integrating the
            Bitbucket API to fetch and display status.
        </>,
        <>
            Integrated Consent Management Service to track and manage cookies in the project. 
        </>,
        <>
            Implemented brand new themes in two of the group's stores, reflecting the
    ...
    },
    {
        ...
        details: [
        <>
            Developed corporate websites for end clients using vanilla Javascript.
        </>,
        ],
    },
];
